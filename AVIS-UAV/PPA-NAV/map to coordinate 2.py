...
def map_callback(msg):
    ...
    x_coord = np.arange(0, 20 * msg.info.resolution * msg.info.width, 20 * msg.info.resolution)
    y_coord = np.arange(0, 20 * msg.info.resolution * msg.info.height, 20 * msg.info.resolution)
